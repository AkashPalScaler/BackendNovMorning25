...
public class Client {
    public static void main(String[] args) {
        ...
        parkingLot.setSlot_allocation_type(SlotAllocationType.HYBRID);
...
//        parkingLot.setSupportedVehicleTypes(null);
        ...
        av1List.add(new AllowedVehicle(VehicleType.TWO_WHEELER, 3));
        List<AllowedVehicle> av2List = new ArrayList<>();
        av2List.add(new AllowedVehicle(VehicleType.FOUR_WHEELER, 1));
        List<AllowedVehicle> av3List = new ArrayList<>();
        av3List.add(new AllowedVehicle(VehicleType.TWO_WHEELER, 1));
        List<AllowedVehicle> av4List = new ArrayList<>();
        av4List.add(new AllowedVehicle(VehicleType.TWO_WHEELER, 1));
        ...
        // HW: This needs to be stored in a repository in memory
//        parkingLotRepository.insert(parkingLot);
        ...
        requestDTO.setVehicle_type(VehicleType.FOUR_WHEELER);
        ...
        requestDTO2.setVehicle_type(VehicleType.FOUR_WHEELER);
